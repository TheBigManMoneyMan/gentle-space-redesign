  ...
  const teamMembers = [
    {
      ...
      landAcknowledgment: "I am a settler of French and Ukrainian descent, and currently live on the unceded land of the Lekwungen speaking first nations peoples.",
      image: founderImage,
    ...
    },
    {
      ...
      bio: "I hold a Master of Counselling Psychology degree from City University in Victoria, BC. I am also a Certified Sexual Health Educator and Somatic Coach, with over 20 years of experience supporting youth and adults as a Counselor, Facilitator, youth and family worker, and Educator.",
      landAcknowledgment: "I am a settler of Italian, Irish, and English ancestry and grew up in the Great Lakes region on Treaty 19 lands.",
      image: teamJay,
      socials: { facebook: "#", twitter: "#", linkedin: "#" },
    },
  ];
            ...
            >
              ...
              <div className="p-6 pb-0">
                <img
                  ...
                  className={`w-full h-72 object-cover rounded-lg ${
                    member.name.includes("Jay") ? "object-[center_30%]" : "object-top"
                  }`}
                />
              </div>
              ...
              <div className="p-6 text-primary-foreground">
                ...
                {member.landAcknowledgment && (
                  <p className="text-sm leading-relaxed opacity-75 italic mb-6">
                    {member.landAcknowledgment}
                  </p>
                )}
