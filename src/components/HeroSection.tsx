    ...
    <section className="relative min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 gradient-hero">
        ...
        <img
          ...
          className="absolute inset-0 w-full h-full object-cover object-top mix-blend-overlay opacity-20"
        />
      </div>
      ...
      <div className="relative z-10 container-wide mx-auto px-6 lg:px-12 py-32 lg:py-40">
        <div className="max-w-3xl ml-auto lg:ml-[20%]">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/90 mb-8 max-w-xl leading-relaxed">
            Trauma-informed consent education that empowers young athletes to build healthy relationships, understand
            boundaries, and thrive on and off the field.
          </p>
